$(function () {
    ...
    const renderShowcaseModal = (studentInfo) => {
        let html = '';
        let showcases = studentInfo["0"].showcase;
        ...
        if (showcases == 0) {
            ...
            showcases.forEach((showcase) => {
                ...
                html += '<h5 class="card-title">' + showcase.projectName + '</h5>';
                html += '<p class="card-text">' + showcase.description + '</p>';
                html += '<a href="' + showcase.githubUrl + '"><i class="fab fa-github fa-2x"></i> </a>';
                html += '<a href="' + showcase.demoVideo + '"><i class="fab fa-youtube fa-2x"></i></a>';
                html += '<a href="' + showcase.url + '"><i class="fas fa-code fa-2x"></i></a>';
                html += '</div></div>';
            });
            html += '</div></div></div>';
            return html;
